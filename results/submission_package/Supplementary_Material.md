...
*Finding:* Both in-processing reductions achieve low statistical disparity ($	ext{DPD} \le 0.0300$, $	ext{EOD} \le 0.0204$), but suffer severe degradation in global ranking discrimination ($	ext{AUC} \le 0.5616$) and suppress true positive detection rates down to $pprox 13\% - 15\%$.
